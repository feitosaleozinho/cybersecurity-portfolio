...
Portfólio técnico de projetos práticos em cibersegurança desenvolvidos durante a formação no SENAI Cyber e IA.

Cada projeto inclui relatório técnico, evidências e documentação de arquitetura.
...
| NDR + EDR + SOAR — Hospital VidaPlena | SOC / Resposta a Incidentes | Security Onion, Elastic, Wazuh, n8n | ✅ Concluído |
